import { SlashCommandBuilder, type ChatInputCommandInteraction, type TextChannel, type DiscordAPIError, ChannelType } from "discord.js"
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        ...
        .addChannelOption(option =>
            option.setName("channel").setDescription("The channel you want to pin a message in.").setRequired(true).addChannelTypes(ChannelType.GuildText)
        )
